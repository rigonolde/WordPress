...
<html <?php language_attributes(); ?>><!--<![endif]-->
    ...
    <body <?php
    if ($wl_theme_options['box_layout'] == 2) {
        body_class('boxed');
    } else
        body_class();
    ?>>
                            ...
                            <div class="col-md-6 col-sm-12 wl_rtl" >
                                <div claSS="logo logocenter">
                                    <a href="<?php echo esc_url(home_url('/')); ?>" title="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>" rel="home">
                                        ...
                                        ?>
                                        <?php if (has_custom_logo()) { ?> <img src="<?php echo $image[0]; ?>" height="<?php echo $wl_theme_options['logo_height'] ?>" width="<?php echo $wl_theme_options['logo_width'] ?>"> <?php } else { ?> <h1><?php
